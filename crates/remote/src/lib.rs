...
/// Process-global named native channels (docs/design/extensions.md).
pub mod channel;
...
/// Largest transport frame, excluding its private four-byte length prefix.
pub const MAX_FRAME_SIZE: usize = 16 * 1024 * 1024;
/// Largest payload inside one `S2C_FRAGMENT` frame.
pub const MAX_FRAGMENT_CHUNK: usize = MAX_FRAME_SIZE - 2;
/// Most fragments allowed to form one logical S2C message.
pub const MAX_FRAGMENT_COUNT: usize = 16_384;
/// Largest logical S2C message after fragment reassembly.
pub const MAX_LOGICAL_MESSAGE: usize = MAX_DECOMPRESSED;
