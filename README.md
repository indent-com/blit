...
| `BLIT_SURFACE_BANDWIDTH` | `medium`                                                                                                               | Ceiling on video bandwidth: `low`, `medium`, `high`, `ultra`, or a raw AV1 quantizer `10`–`255`. Adaptation is always on and only moves cheaper than this                                                                                 |
