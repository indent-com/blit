...
| `BLIT_EVENTS_SIZE`       | `1048576`                                                                                                         | Binary server event-ring capacity                                                                                                                                                                                                         |
| `BLIT_EVENTS`            | low-throughput lifecycle events                                                                                   | Fine-grained event names/selectors (`default,+frame.*,+pty.*`, or `all`)                                                                                                                                                                  |
| `BLIT_EVENTS_FILE`       | unset                                                                                                             | Stream binary events to this server-side file from startup                                                                                                                                                                                |
