...
**`js/web-app/`** is the browser UI served by either path. It provides multi-session management, BSP layouts, search, font/palette selection, and reconnection handling.
